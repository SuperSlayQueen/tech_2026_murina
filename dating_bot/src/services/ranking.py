...
from src.backend.models import Profile, User, Like, Rating
...
class RankingService:
    ...
    async def get_ranked_profiles(self, session: AsyncSession, user_id: int, user_profile: Profile) -> list:
        """
        Получить ранжированный список анкет для пользователя
        Реализует все 3 уровня рейтинга
        """
        ...
        # Базовый запрос - только противоположный пол и не текущий пользователь
        target_gender = 'female' if user_profile.gender == 'male' else 'male'
